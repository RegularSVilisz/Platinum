...
Entity.HeartBeat = game:GetService("RunService").Heartbeat:Connect(function()
	...
	Entity.HumanoidRootPart = Entity.Humanoid ~= nil and Entity.Humanoid.RootPart ~= nil and Entity.Humanoid.RootPart or Entity.Character ~= nil and Entity.Character:FindFirstChild("HumanoidRootPart") ~= nil and Entity.Character:FindFirstChild("HumanoidRootPart") or Entity.Character ~= nil and Entity.Character.PrimaryPart ~= nil and Entity.Character.PrimaryPart or nil
